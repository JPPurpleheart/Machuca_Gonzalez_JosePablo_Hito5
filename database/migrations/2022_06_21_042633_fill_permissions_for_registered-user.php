...
class FillPermissionsForRegisteredUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRegisteredUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.registered-user.index',
            'admin.registered-user.create',
            'admin.registered-user.show',
            'admin.registered-user.edit',
            'admin.registered-user.delete',
        ]);
