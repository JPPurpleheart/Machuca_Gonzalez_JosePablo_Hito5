...
class FillPermissionsForDespensa extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDespensa constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.despensa',
            'admin.despensa.index',
            'admin.despensa.create',
            'admin.despensa.show',
            'admin.despensa.edit',
            'admin.despensa.delete',
        ]);
