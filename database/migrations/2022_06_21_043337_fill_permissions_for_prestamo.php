...
class FillPermissionsForPrestamo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPrestamo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.prestamo',
            'admin.prestamo.index',
            'admin.prestamo.create',
            'admin.prestamo.show',
            'admin.prestamo.edit',
            'admin.prestamo.delete',
        ]);
