...
class FillPermissionsForEditorial extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEditorial constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.editorial',
            'admin.editorial.index',
            'admin.editorial.create',
            'admin.editorial.show',
            'admin.editorial.edit',
            'admin.editorial.delete',
        ]);
